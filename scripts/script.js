...
var DF_MNe = DF_Mw(["hr{border:0;border-top:1px solid #e0e0e0;margin:0}.hidden{display:none}.card-wrapper{background-color:#fff;border:1px solid #e0e0e0;border-radius:8px;box-shadow:0 2px 2px 0 rgba(0,0,0,.24);margin-top:10px}"]);
